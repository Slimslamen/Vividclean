...
export default function Navbar(): JSX.Element {
  ...
  return (
    <nav className=" z-20 sticky top-0 bg-customBeige border-gray-200 dark:border-gray-600 dark:bg-gray-900">
      <div className="ml-2 flex flex-wrap justify-center lg:justify-between items-center xl:mx-auto max-w-screen-xl p-0">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          />
          <span className="self-center text-wrap text-xl md:text-2xl font-semibold whitespace-nowrap text-customDark dark:text-white">
        ...
        <div
          id="mega-menu-full"
          className={`items-center justify-center md:justify-between font-medium w-full md:flex md:w-auto md:order-1 ${
          ...
          {menuItems.map((item, index) => (
              <li key={index}>
                <button
                  ...
                  className={
                    "flex items-center justify-center md:justify-between w-full py-2 px-3 text-gray-900 rounded md:w-auto hover:bg-customHover md:hover:bg-transparent md:border-0 md:hover:text-customDark md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
                  }
